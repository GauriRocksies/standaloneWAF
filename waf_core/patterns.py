...
Unchanged from the original waf/detectors/patterns.py other than its
new location — this module never had any framework dependency.
...
Severity is intentionally lowercase to match the original project's
AttackLog.Severity choices ('low', 'medium', 'high', 'critical').
"""
