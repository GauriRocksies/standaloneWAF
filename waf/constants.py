...
Central location for constants used throughout the Web Application
Firewall (WAF). Keeping these values here avoids hardcoding strings
and magic numbers across multiple modules.
"""
